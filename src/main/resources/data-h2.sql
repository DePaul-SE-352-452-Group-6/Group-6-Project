...
insert into account_currency(account_id, currency_id,amount) values (3, 2,150);
...
insert into account_inventory(account_id, digital_good_id, amount) values (2, 3,1);
insert into account_inventory(account_id, digital_good_id, amount) values (3, 4,30);